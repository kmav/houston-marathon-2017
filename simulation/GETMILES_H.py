...
for minute in range(0,501,minuteInterval):
	...
	for j in range(27,30):
		altTxtH += str(j-18)+','+str(minute)+','+str(simData[j])+'\n'
	
		
file = open("../data/DensitiesS.csv",'w')
file2 = open("../data/RunnerDataStack.csv",'w')	
file3 = open("../data/RunnerDataHalfStack.csv","w")
file.write(txt)
file2.write(altTxt)
file3.write(altTxtH)
